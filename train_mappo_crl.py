...
class MAPPOTrainer:
    def __init__(self, grid_size=8, n_agents=2, total_steps=500_000, rollout_len=2048):
        ...
        os.makedirs("./checkpoints/mappo/mappo_1/", exist_ok=True)
        os.makedirs("./tensorboard/mappo/mappo_1/", exist_ok=True)
    ...
    def train(self):
        ...
        for update in range(total_updates):
            ...
            if update % 10 == 0:
                ...
                torch.save(self.model.state_dict(), f"./checkpoints/mappo/mappo_1/mappo_update_{update}.pt")
