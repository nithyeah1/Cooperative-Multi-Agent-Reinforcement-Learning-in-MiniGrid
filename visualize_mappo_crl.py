...
import torch
from train_mappo_minigrid import MAPPOActorCritic
...
def visualize_mappo(model_path, grid_size=8, max_steps=100, delay=0.3):
    """Visualize MAPPO-trained agents in MultiAgent MiniGrid"""
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='Visualize MAPPO-trained agents')
    parser.add_argument('--model', type=str, default='./checkpoints/mappo/mappo_1/mappo_update_240.pt',
